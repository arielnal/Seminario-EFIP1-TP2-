 ...
 * @author ariel
 */
public class DensidadCRUD extends javax.swing.JFrame implements Limpiar {
    ...
    public void LimpiarCasilleros() {
        valIndJT.setText(VACIAR);
        aAltaJT.setText(VACIAR);
        indiceJT.setText(VACIAR);
        denoJT.setText(VACIAR);
    }    
}
