 ...
 * @author ariel
 */
public class FinanciacionCRUD extends javax.swing.JFrame implements Limpiar {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Guardar equema");
    ...
    public void LimpiarCasilleros() {
        grupo.setText(VACIAR);
        año.setText(VACIAR);
        apInicial.setText(VACIAR);
        indiceJT.setText(VACIAR);
        cuotaJT.setText(VACIAR);
    }
